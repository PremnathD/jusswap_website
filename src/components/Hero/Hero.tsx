  ...
  return (
    <section className="relative w-full min-h-[calc(100vh-80px)] flex items-center overflow-hidden bg-white">
      ...
      <div className="w-full max-w-[1280px] mx-auto px-6 py-12 md:py-20 relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8">
        ...
        <div className="flex-1 w-full max-w-[640px] flex flex-col items-start z-10">
          
          {/* Main Typography Funnel */}
          <h1 className="text-5xl lg:text-[64px] font-extrabold leading-[1.15] tracking-tight text-dark-green mb-6">
          ...
          <p className="text-lg sm:text-xl text-text-muted font-medium max-w-[500px] leading-relaxed mb-10">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mb-12 w-full sm:w-auto">
            ...
            <button className="group w-full sm:w-auto flex items-center justify-center gap-3 px-6 py-3.5 rounded-2xl bg-white border-2 border-gray-100 text-black hover:border-gray-300 hover:-translate-y-1 hover:shadow-[0_12px_24px_rgba(0,0,0,0.05)] transition-all duration-300 active:scale-95">
              <Play size={28} className="text-[#FF3366] fill-current group-hover:scale-110 transition-transform duration-300" />
              <div className="text-left flex flex-col">
          ...
          <div className="flex items-center gap-5 pt-6 border-t border-gray-100 w-full max-w-[400px]">
        ...
        <div className="flex-1 w-full relative content-center flex justify-center lg:justify-end lg:-mr-12 xl:-mr-24 perspective-1000">
